from tkinter import *
from movieProgram.movieUi import insert_infor, update_infor, delete_infor, select_infor, movie_select_all
...
if __name__ == '__main__':
    ...
    select_all = Button(w, text="영화 모두선택", font=("궁서", 30), command = movie_select_all)
